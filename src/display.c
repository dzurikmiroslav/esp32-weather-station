...
#define SPI_RST CONFIG_SPI_RST
#define SPI_CE CONFIG_SPI_CE
#define SPI_DC CONFIG_SPI_DC
#define SPI_DIN CONFIG_SPI_DIN
#define SPI_CLK CONFIG_SPI_CLK
#define PCD8544_BL CONFIG_PCD8544_BL
...
const uint8_t ind_icon[] = {0xFF, 0xFF, 0xFF, 0x81, 0xFF, 0xFF, 0xFF,
                            ...
                            0x00, 0x3C, 0x42, 0x42, 0x42, 0x3C, 0x00,
                            0x00, 0x3E, 0x40, 0x40, 0x40, 0x3E, 0x00,
                            0x00, 0x02, 0x02, 0x7E, 0x02, 0x02, 0x00};

const uint8_t out_icon[] = {0x00, 0x00, 0x00, 0x7E, 0x00, 0x00, 0x00,
                            0x00, 0x7E, 0x04, 0x08, 0x10, 0x7E, 0x00,
                            0x00, 0x7E, 0x42, 0x42, 0x42, 0x3C, 0x00,
                            0xFF, 0xC3, 0xBD, 0xBD, 0xBD, 0xC3, 0xFF,
                            0xFF, 0xC1, 0xBF, 0xBF, 0xBF, 0xC1, 0xFF,
                            0xFF, 0xFD, 0xFD, 0x81, 0xFD, 0xFD, 0xFF};
